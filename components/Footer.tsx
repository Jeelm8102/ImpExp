...
export default function Footer() {
  return (
    <footer className="bg-ink border-t border-alabaster/[0.08] pt-16 pb-8">
      <div className="mx-auto max-w-7xl px-6 md:px-10">
        <div className="grid md:grid-cols-4 gap-12 pb-14">
          <div>
            ...
            <p className="mt-3.5 text-sm text-alabaster/55 leading-relaxed max-w-xs">
          ...
          <div>
            <p className="eyebrow text-alabaster/40 mb-5">Company</p>
          ...
          <div>
            <p className="eyebrow text-alabaster/40 mb-5">Head Office</p>
          ...
          <div>
            <p className="eyebrow text-alabaster/40 mb-5">Trade Desk</p>
            <p className="text-sm text-alabaster/70 leading-relaxed font-mono">
              +91 484 220 1994
              <br />
        ...
        <div className="h-px bg-alabaster/[0.08]" />

        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-alabaster/40 font-mono">
