export default function CTA() {
  return (
    <section id="contact" className="relative bg-ink py-32 md:py-40 overflow-hidden text-center">
      <div className="absolute -inset-[10%] blur-[80px] opacity-[0.35]">
      ...
      <div className="relative z-[2] mx-auto max-w-2xl px-6 md:px-10">
        ...
        <p className="mt-6 text-alabaster/60 max-w-lg mx-auto">
